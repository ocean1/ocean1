...
| **[MQTT-Disallowed-Unicode-v1.00](https://docs.oasis-open.org/mqtt/disallowed-chars/v1.0/disallowed-chars-v1.0.html)**                                                    | **MQTT Oasis Standard**                     | Improper Validation       | Medium         | (Persistent) Denial of service via malformed MQTT packets           | 2018 |
